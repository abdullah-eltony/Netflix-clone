...
const Rows = (movie, i, admin) => {
  return (
    <tr key={i}>
      ...
      <td className={`${Text} flex-rows gap-2 justify-end items-center mt-1`}>
        {admin ? (
          <>
            <button className="bg-dry border-border border rounded flex-rows gap-2 text-border py-1 px-2">
          ...
          <>
            ...
            <Link
              ...
              className="bg-subMain text-white  rounded flex-rows gap-2 py-1 w-6 h-6 flex-cols"
            >
              <GoEye />
            </Link>
          </>
